...
public class EduLink_Register {
    class public func registerCodes(_ rootCompletion: @escaping completionHandler) {
        ...
        let body = "{\"jsonrpc\":\"2.0\",\"method\":\"EduLink.RegisterCodes\",\"params\":{\"learner_id\":\"\(EduLinkAPI.shared.authorisedUser.id!)\",\"authtoken\":\"\(EduLinkAPI.shared.authorisedUser.authToken!)\"},\"uuid\":\"\(UUID.uuid)\",\"id\":\"1\"}"
